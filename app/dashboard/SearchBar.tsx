  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className={`bg-white/[0.05] border border-white/10 rounded-lg pl-8 pr-3 py-1.5 text-sm text-white placeholder-white/25 focus:outline-none focus:border-white/25 w-full transition-opacity ${isPending ? 'opacity-50' : ''}`}
      />
    </div>
  )
}
