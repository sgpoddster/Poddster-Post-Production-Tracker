  ...
  while (url) {
    ...
    for (const item of items) {
      ...
      if (type === 'file') {
        ...
        files.push({ id: fileId, name, playerUrl: `https://next.frame.io/project/${projectId}/view/${fileId}` })
        ...
        files.push({ id: headId, name, playerUrl: `https://next.frame.io/project/${projectId}/view/${headId}` })
